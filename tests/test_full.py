...
def test_full(tmpdir):
    ...
    fs.adaptation.get_details_by_location([395133768], "property", csv=True, output_dir=tmpdir)
    fs.adaptation.get_details_by_location([7924], "neighborhood", csv=True, output_dir=tmpdir)
    fs.adaptation.get_details_by_location([1935265], "city", csv=True, output_dir=tmpdir)
    fs.adaptation.get_details_by_location([50158], "zcta", csv=True, output_dir=tmpdir)
    fs.adaptation.get_details_by_location([39061007100], "tract", csv=True, output_dir=tmpdir)
    fs.adaptation.get_details_by_location([19047], "county", csv=True, output_dir=tmpdir)
    fs.adaptation.get_details_by_location([3915], "cd", csv=True, output_dir=tmpdir)
    fs.adaptation.get_details_by_location([39], "state", csv=True, output_dir=tmpdir)
